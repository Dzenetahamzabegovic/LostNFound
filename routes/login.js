...
const secretKey = process.env.SECRET_KEY  // Change here
 ...
 * @apiGroup Login
 * 
 * @apiBody (Request body) {String} userName The userName of the account you want to connect with  // Change here
